...
* Разделение прав доступа: администратор / студент;
...
| Роль                         | Возможности                                                                                              |
| ---------------------------- | -------------------------------------------------------------------------------------------------------- |
| Администратор            | Полный доступ к редактированию расписания всех пользователей; управление аккаунтами; просмотр статистики |
